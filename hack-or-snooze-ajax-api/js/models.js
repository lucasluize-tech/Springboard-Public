...
class StoryList {
  ...
  static async getStories() {
    ...
    //  instance method? cuz there's only one instace to use it on.
  ...
  async removeStory(user, storyId){
    ...
    user.ownStories = user.ownStories.filter(story => (story.storyId !== story.storyId))
